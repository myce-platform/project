...
library Errors {
    ...
    string public constant NOT_IN_WHITE_LIST = 'NOT_IN_WHITE_LIST';
    string public constant INVALID_FEE_AMOUNT = 'INVALID_FEE_AMOUNT';


    string public constant CAN_NOT_CANCEL = 'CAN_NOT_CANCEL';
    string public constant LOWER_THAN_RESERVE_PRICE = 'LOWER_THAN_RESERVE_PRICE';
}
